...
1. Responder攻擊非常有趣，且能練習到的時機並不多
2. 針對ADCS的枚舉是第一次嘗試，有開放SSL類服務的靶機應該都要嘗試一下

### 浪費時間的部分：

1. 第一時間並未想到ADCS，在內網提權花了點時間
...
1. Responder攻擊其實屬於中間人攻擊，相對在實戰中比較常見
2. 針對ADCS的枚舉應列入常規枚舉名單
3. ADCS類漏洞通常依賴配置錯誤，相對常見
